...
[requirements.md](./requirements.md) — спецификация PomidorQA: 50 функциональных требований MVP
с номерами разделов, на которые ссылаются тесты и матрица. Это основа расчёта покрытия.
